...
//      ql::utils::write_file(mapper_in_fname.str(), mapper_in_qasm.str());
        ...
        mapper_out_qasm << "version 1.0\n";
        mapper_out_qasm << "# this file has been automatically generated by the OpenQL compiler please do not modify it manually.\n";
        for(auto &kernel : kernels)
        {
            ...
            mapper_out_qasm << kernel.get_prologue();
            if (! kernel.c.empty())
            {
                ...
                mapper_out_qasm << "qubits " << kernel.qubit_count << "\n";
                mapper_out_qasm << ql::ir::qasm(kernel.bundles) << std::endl;

                mapper.GetHighestQubitIndex(kernel.qubit_count);
            ...
            mapper_out_qasm << kernel.get_epilogue();
        }
        mapper_out_qasm << "# Total depth: " << total_depth << "\n";
        mapper_out_qasm << "# Total no. of quantum gates: " << total_quantum_gates << "\n";
        mapper_out_qasm << "# Total no. of classical operations: " << total_classical_operations << "\n";
        mapper_out_qasm << "# No. kernels: " << kernels.size() << "\n";
        ...
        rcscheduler_out_qasm << "version 1.0\n";
        rcscheduler_out_qasm << "# this file has been automatically generated by the OpenQL compiler please do not modify it manually.\n";
        ...
        for(auto &kernel : kernels)
        {
            ...
            rcscheduler_out_qasm << kernel.get_epilogue();
        }
