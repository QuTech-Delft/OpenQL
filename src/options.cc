...
private:
    ...
    void set_defaults() {
        ...
        app->add_set_ignore_case("--mapassumezeroinitstate", opt_name2opt_val["mapassumezeroinitstate"], {"no", "yes"}, "Assume that qubits are initialized to zero state", true);
...
public:
    Options(const std::string &app_name = "testApp") {
