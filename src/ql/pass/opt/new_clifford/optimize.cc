...
#include "ql/pass/opt/new_clifford/optimize.h"
...
utils::Int CliffordOptimizePass::run(
    ...
    auto cycles_saved = detail::Clifford().optimize_blocks(ir);
    // FixME loop over one block, put the loop over all blocks in here
