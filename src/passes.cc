 ...
 */
CommuteVariationPass::CommuteVariationPass(const std::string &name) : AbstractPass(name) {
}
 ...
 */
void CommuteVariationPass::runOnProgram(ql::quantum_program *program) {
    ql::commute_variation(program, program->platform, getPassName());
}
