...
class quantum_program
{
   ...
   public:
      ...
      std::string qasm()
      {
         ...
         {
            kernels[k].get_qubit_usecount(usecount);
            ...
            total_timetaken += kernels[k].timetaken;
         }
	/*
         ss << ".cal0_1\n";
         ss << "   prepz q0\n";
	 ...
	 */
      ...
      void schedule()
      {
         ...
         sched_qasm << "# Total time taken: " << total_timetaken << "\n";
