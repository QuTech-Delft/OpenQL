...
void Backend::compile(const ir::ProgramRef &program, const plat::PlatformRef &platform) {
    ...
    pass::sch::schedule::detail::rcschedule(program, platform, "rcscheduler");
#else
    // schedule without resource constraints
    pass::sch::schedule::detail::schedule(program, platform, "scheduler");
#endif
...
Str Backend::kernelLabel(const ir::KernelRef &k) {
