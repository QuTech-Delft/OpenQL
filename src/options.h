...
namespace ql
{
  ...
  public:
      Options(std::string app_name="testApp")
      {
          ...
          opt_name2opt_val["maxfidelity_idlefid"] = "0.9868";
          ...
          app->add_set_ignore_case("--maxfidelity_idlefid", opt_name2opt_val["maxfidelity_idlefid"], {"0.9867, 0.9868"}, "Mapper maxfidelity heuristic average idle-qubit gate fidelity", true);
