/** \file
 * Defines the Clifford optimizer pass using the new IR
 */
...
/**
 * Clifford optimizer pass using the new IR.
 */
class CliffordOptimizePass : public pmgr::pass_types::Transformation {
protected:
