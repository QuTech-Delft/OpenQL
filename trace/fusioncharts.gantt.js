    ...
    Q.register("module", ["private", "modules.renderer.js-gantt", function() {
        ...
        da("gantt",
        {
            ...
            _createDatasets: function() {
                var a = this.config, b = this.components, c = this.jsonData, d = [], f, e, h = this.defaultDatasetType, m = this.applicableDSList, g, l, n, u = a.datasetMap || (a.datasetMap = {
                    task: [],
                    milestone: [],
                    connectors: []
                }), p = {
                ...
                c = b.dataset = [];
                for (b = 0; b < f; b++)
                    if (n = d[b], n.task ? x = g = "task" : n.milestone ? x = g = "milestone" : n.connector && (g = "connectors", x = "connector"), g = g && g.toLowerCase(), m[g] || (g = h), l = Q.get("component", ["dataset", g]))
                        void 0 === k[g] ? k[g] = 0 : k[g]++, e = u[g], (t = e[0]) ? (l = t.JSONData, l = l[x].length, A = n[x].length, p[g].push(t), c.push(t), t.index = b, l > A && t.removeData(A -
            ...
            _createLegendItems: function() {
                var a = this.components, b = this.jsonData, c = a.legend, d, f, e, h, m, g, l = a.legendItems, b = b.legend && b.legend.item || [];
                ...
                for (a = b.length; d < a; d++)
                    m = b[d], g = l[d], h = m.color, f = Ba(h, 60).replace(Fa, Ga), e = Ba(h, 40), e = {
                        FCcolor: {
                            color: h + "," + h + "," + e + "," + h + "," + h,
                            ratio: "0,70,30",
                            angle: 270,
            ...
            _createAxes: function() {
                var a = this.components, b = Q.get("component", ["axis", "time"]), c = Q.get("component", ["axis", "process"]);
                a.yAxis = [];
                a.xAxis = [];
                a.yAxis[0] = c = new c;
                a.xAxis[0] = a = new b;
            ...
            _setAxisValuePadding: function() {
                ...
                for (c = 0; c < b; c++)
                    d = a[c], d = d.getAxisValuePadding && d.getAxisValuePadding() || {}, f = M(f, d.left||-Infinity), e = M(e, d.right||-Infinity)
            },
            ...
            _drawCanvas: function() {
                var a = this.jsonData.chart, b = this.components, c = this.config, d = this.graphics, f = b.paper, e = b.canvas, b = e.graphics, h = e.config, e = h.clip = {}, m = b.canvasBorderElement, g = this.get("config",
                "animationObj"), l = g.duration, n = g.dummyObj, u = g.animObj, g = g.animType, p = b.canvasElement, t = c.actualCanvasLeft, A = c.actualCanvasTop, x = c.canvasWidth, k = c.canvasHeight, C = c.canvasLeft, F = c.canvasTop, q = c.canvasWidth + c.totalWidth, c = c.canvasHeight + c.totalHeight, d = d.canvasGroup, y = h.canvasBorderRadius, z = h.canvasBorderWidth, v = .5 * z, w = h.canvasBorderColor, G = h.canBGColor, D = h.shadow, a = h.showCanvasBG=!!r(a.showcanvasbg, 1), B = h.shadowOnCanvasFill, E = h.showCanvasBorder, h = {
                    x: t - v,
                    y: A - v,
                    width: q + z,
                    height: c + z,
            ...
            _postSpaceManagement: function() {
                var a = this.config, b = this.components, c = b.xAxis && b.xAxis[0], d = b.yAxis && b.yAxis[0], f = d.getAxisConfig("processTotalHeight"), e = a.canvasHeight, h = b.legend, m = a.xDepth, g = b.canvas.config, l = g.canvasBorderWidth, n = g.canvasPadding, u = b.vScrollBar.userConf, p, t = g.canvasPaddingLeft, g = g.canvasPaddingRight, A = a.ganttpanedurationunit, x = b.hProcessScrollBar, b = (b = b.hScrollBar) && b.userConf.height || 0, x = x && x.userConf.height ||
                0, k, r;
            ...
            _manageScrollerPosition: function() {
                var a = this.config, b = this.components, c, d = b.hScrollBar, f = b.vScrollBar, e = b.hProcessScrollBar, h = a.totalWidth || 0, m = a.totalHeight || 0;
            ...
            updateManager: function(a, b) {
                var c = this.config, d = this.config.viewPortConfig, f = d.scaleX, e = this.components.xAxis[0], h = this.components.yAxis[0], m = this.graphics.datasetGroup, g = this.graphics.datalabelsGroup, l = this.graphics.trackerGroup, n = c.xOffset || 0, u = c.yOffset || 0, p = c.canvasHeight, t =
            ...
            _setAxisScale: function() {
                var a = this.components, b = this.config, c = a.xAxis[0], d = c.getLimit(), f = d.max, d = d.min, e = new Date(d), h = a.yAxis[0], m = this.components.numberFormatter, g = Number(b.ganttpaneduration), l = b.scrollOptions ||
                (b.scrollOptions = {}), n = b.ganttpanedurationunit, u = f - d, d = b.canvasHeight, p = b.scrolltodate, t = b.canvasWidth, A = b.canvasLeft, x = a.hProcessScrollBar, a = (a = a.hScrollBar) && a.userConf.height || 0, x = x && x.userConf.height || 0, k = c.getPixel(f) - A, f = h.getAxisConfig("processTotalHeight");
            ...
            drawScrollBar: function() {
                var a =
                this, b = a.config, c = a.components, d = c.xAxis[0], f = d.config, e = d.config.axisRange, h = b.viewPortConfig, m = b.scrollOptions || (b.scrollOptions = {}), g = e.max, l = e.min, n = m.horizontalVxLength, u = c.hScrollBar, e = u.node, p = c.vScrollBar, t = p.node, A = c.hProcessScrollBar, x = A.node, k = b.useverticalscrolling, q = g - l, F = b.canvasRight, H = h.scaleX, y = h.scaleY, z, v, w, G, D, B = b.vScrollEnabled, E = c.yAxis[0], I = B ? p.conf.width: 0, L = a.graphics, S = c.paper;
                z = b.canvasLeft;
                v = b.canvasTop;
                w = b.canvasHeight;
                G = b.canvasWidth;
            ...
            drawLegend: function() {
                var a = this.config, b = this.components.legend, c = b.config, d = c.width, f = c.height, e = a.marginLeft, h = a.marginTop, m = a.width, g = a.marginRight, l = a.marginBottom, n = a.totalWidth + a.canvasWidth, u = a.totalHeight + a.canvasHeight, a = a.height;
            ...
            _setClipping: function() {
                ...
                this.graphics.datalabelsGroup, d = this.graphics.trackerGroup, f = a.viewPortConfig, e = f.scaleX, f = f.x, h = this.config.animationObj, m = h.dummyObj, g = h.animObj, l = h.animType, h = h.transposeAnimDuration, n = this.components.canvas.config.clip["clip-canvas"].slice(0);
            ...
            _createToolBox: function() {
                var a = this.components, b = a.yAxis[0], c = this._scrollBar, d = a.actionBar, f = c.get, e = c.add, h;
        ...
        Q.register("component", ["dataset", "Task", {
            ...
            _setConfigure: function(a) {
                ...
                a = a || e.task;
                var h = (d.processes ||
                {}).process || [], d = a && a.length, m = c.components.colorManager, g = c.get("config"), l = c.get("components", "numberFormatter"), n = g.taskbarfillmix, u = g.taskbarfillratio, p = g.showslackasfill, t = this.components.data, A, x, k, C, F, H, y, z = g.dateintooltip, v, w, h = h.length, G = {
                    right: "right",
                    left: "left",
                    undefined: "center",
                    center: "center"
                }, D, B, E, O, L, S, K, J, Q = c.components.tasksMap = {}, N = g.style.inCanvasStyle, P, Ca, R, W = 0, V = g.dataLabelStyle, Z;
            ...
            draw: function() {
                ...
                a = this.visible;
                var b = this.chart,
                c = b.jsonData, d = b.get("config"), f = b.get("config", "animationObj"), e = f.duration, h = f.dummyObj, m = f.animObj, f = f.animType, g = b.components, l = d.canvasTop, n = g.paper, g = g.xAxis[0], u, p = this.yAxis;
                ...
                var H = this.graphics.dataLabelContainer, y = function() {
                    H.show()
                }, z = this.graphics, v = z.container, z = z.shadowContainer, t = t.pool || [], w, G, D, B, E, O, L, S, K, J, M, Q, P, N, R, V, T, Z;
                Z = d.showtooltip;
                var X = d.datepadding,
                U = d.viewPortConfig, Y = U.x, aa = b.getJobList(), c = c.processes.process && c.processes.process.length, U = U.scaleX, ba = d.taskbarroundradius, ca = d.showshadow;
                G = this.config;
                ...
                this.drawn=!0;
                for (a = 0; a < F; a++)
                    this._removeDataVisuals(q.shift())
            },
            drawLabel: function() {
                var a =
                this.chart, b = a.components.paper, c = this.components.data, d = this.components.pool || {}, f, e;
                e = a.get("config", "animationObj");
                var h = e.dummyObj, m = e.animObj, g = e.duration, l = e.animType, n, u, p, t = this.graphics.dataLabelContainer, A, x = c.length;
                for (A = 0; A < x; A++)
                    n = c[A], e = n.config, P = n.graphics, f = P.label, u = e.eventArgs, pa(e.label) && "" !== e.label ? (p = e._labelTextAttr, (f = P.label || (P.label = d.valElem && d.valElem.shift())) ? (f.removeCSS(), f.show().animateWith(h, m, p, g, l).css(e.style)) : (f = n.graphics.label = b.text(p, e.style, t).data("dataset",
            ...
            taskHoverHandler: function() {
                var a = this.data("dataObj") || {}, b = this.data("dataset").components.data, a = a.config || {}, c = a.index, b = b[c] && b[c].graphics, c = {
            ...
            _removeDataVisuals: function(a) {
                ...
                if (a)
                    for (c in d = a.graphics, d)
                        a = b[c] || (b[c] = []), f = d[c], f.hide && "function" === typeof f.hide && (f.attr({
                            "text-bound": []
        ...
        Q.register("component", ["dataset", "Milestone", {
            ...
            _setConfigure: function(a) {
                var b = this.chart, c = this.JSONData, d = (a = a || c.milestone) && a.length, f = b.components.colorManager, e = b.get("config"), h = b.get("components", "numberFormatter"), m = this.components.data, g = b.config.style,
                l = g.inCanvasStyle, n = b.components.tasksMap, u, p, t, A, x, k, C, F = b.config.milestoneLabelStyle, H;
            ...
            draw: function() {
                var a = this.chart, b = a.components, c = b.xAxis[0], d = this.components.data, f = b.tasksMap, e = a.config, h = a.get("config", "animationObj"), m = h.duration, g = this.graphics.container, l = a.graphics.parentMilestoneGroup, n = this.graphics.dataLabelContainer,
                u = this.visible, b = b.paper, p = this.components.removeDataArr || [], t = p.length, A = h.dummyObj, x = h.animObj, h = h.animType, k, q, F, H, y, z, v, w, G = a.getJobList();
                k = e.showtooltip;
                ...
                for (n = 0; n < u; n += 1)
                    if (k = d[n])
                        l = k.config, q = f[l.taskId], !k.graphics && (k.graphics = {}), F = k.graphics, z = F.element,
        ...
        Q.register("component", ["dataset", "Connectors", {
            ...
            _setConfigure: function(a) {
                var b = this.config, c = this.chart, d = this.JSONData, f = (a = a || d.connector) && a.length || 0, e = c.components.colorManager, c = c.get("config"), h = this.components.data, m, g, l, n, u, p, t;
            ...
            draw: function() {
                var a = this.chart, b = a.components, c = this.components.data, d = b.paper, f = c.length, b = b.tasksMap, e = a.config.connectorextension, h = a.graphics.parentConnectorsGroup, m = this.graphics.container, g = this.components.pool || [], l = this.visible, n = a.get("config", "animationObj"), u = n.duration, p = n.dummyObj, t = n.animObj, n = n.animType,
                A = this.components.removeDataArr || [], x = A.length, k, r, q, H, y, z, v, w, G, D, B, E, I, J, N, K;
                ...
                for (K = 0; K <= f; K += 1)
                    if (h = c[K])
                        if (B = h.config, !h.graphics && (h.graphics = {}), l = h.graphics, k = B.fromTaskId && B.fromTaskId.toLowerCase(), r = B.toTaskId && B.toTaskId.toLowerCase(), k = b[k], q = b[r], r = l.connector, k && q) {
                            ...
                            r && r.hide();
                for (K = 0; K < x; K++)
                    this._removeDataVisuals(A.shift())
                    },
            ...
            rollOverHandler: function(a) {
                return function(b) {
                    var c = this.data("dataObj"), d = c.config, f = a.components.tasksMap, e = f[d.fromTaskId], f = f[d.toTaskId], h = {
                        stroke: d.hoverColor,
        ...
        Q.get("component", ["axis", "ganttCommon", {
            _drawPlotLine: function() {
                var a = this.config, b = this.chart, c = a.canvas, d = b.config, f = a.ganttPlotLineContainer, e = c.canvasBottom || d.canvasBottom, h = c.canvasLeft || d.canvasLeft, m = c.canvasRight || d.canvasRight, g = c.canvasTop || d.canvasTop, l = b.components.paper, n = a.gridArr, c = this.graphics.line || [], d = a.animateAxis, u, p = 0, t, q, r = [], k, C;
                ...
                t = 0;
                for (q = n.length; t < q; t += 1)
                    void 0 !== n[t].x ? r.push("M", n[t].x, g, "L", n[t].x, e) : r.push("M", h, n[t].y, "L", m, n[t].y);
            ...
            b) {
                var c = this.config, d = c.isVertical, f = c.lastTranslate || (c.lastTranslate = {
                    x: 0,
                    y: 0
            ...
            _drawProcessAndDataTableStyleParser: function(a) {
                var b =
                this.config, c = this.chart, d = c.linkedItems.smartLabel, f = c.components.colorManager, e = b.labels.style, h = a.elem || {}, m = a.dimension, g = h._attrib || {}, l = m.left, n = m.right, u = m.top, p = m.bottom, t, A, x, k, C, F, H, y, z, v, w, G, D;
                switch (a.type) {
                case "category":
                case "datatable":
                case "process":
            ...
            _drawProcessAndDataTableElement: function(a) {
                var b = this, c = b.config, d = b.chart, f = d.components, e = b.components.categoryElement || [], h = c.hoverElemsArr || (c.hoverElemsArr = []), m = f.paper, f = a.elemIndex, g = c.labelHoverEventName,
            ...
            _drawGridLine: function() {
                var a = this.config, b = this.chart, c = b.components.paper, d = this.graphics.gridLine || [], f = a.animateAxis, e, h, m = 0, g = 0, l = 2, n, u, p, t;
                ...
                for (e = {
                    ...
                    if (0 === g)
                        n = a.gridLinePath, h = a.labelLineContainer;
                    else if (n = a.gridLineHeaderPath, h = a.headerLineContainer, !n)
                        continue;
            ...
            _gridHoverHandler: function() {
                var a = this.data("data"), b = a.type, c = a.dimension, d = a.axis, f = d.chart, e = f.config, h = f.components.paper, m = d.config, f = m.hoverElemsArr || [], m = m.ganttPlotHoverBandContainer, d = d.graphics.plotHoverElement || (d.graphics.plotHoverElement = []), b = "category" === b ? {
                    x: c.left,
                    y: e.canvasTop,
                ...
                if (a.useHover && f[a.pos])
                    for (b = 0, c = f[a.pos].length; b < c; b += 1)
                        f[a.pos][b].bgElem.attr({
                            fill: a.rollOverColor
                        })
            },
            _gridOutHandler: function() {
                var a = this.data("data"), b = a.axis, c = b.config.hoverElemsArr || [], b = b.graphics.plotHoverElement || [], d, f;
                a.usePlotHover && b[0] && b[0].hide();
                if (a.useHover && c[a.pos])
                    for (b = 0, d = c[a.pos].length; b < d; b += 1)
                        f = c[a.pos][b], f.bgElem.attr({
                            fill: f.bgColor
                        })
            },
        ...
        Q.get("component", ["axis", "time", {
            ...
            setCategory: function(a) {
                ...
                var c = this.config, d = c.axisRange, f = c.startPad || 0, e = c.endPad || 0, h, m, g = Infinity, l =- Infinity, n, u;
                c.categories = {};
                if (a) {
                    c.hasCategory = 1;
                    ...
                    for (n in c)
                        if (c.hasOwnProperty(n) && "_attrib" !== n)
                            for (u = 0, a = c[n].category.length; u < a; u += 1)
                                h = c[n].category[u], m = b.getDateValue(h.start).ms, h = b.getDateValue(h.end).ms, isNaN(m) && (m = void 0), m > l && (l = m), m <= g && (g = m),
            ...
            _drawCategories: function() {
                var a = this.config, b = (a.axisDimention || {}).y, c = a.totalHeight || 0, d = this.chart, f = d.components, e = d.config, h = e.viewPortConfig, m = f.paper, f = f.numberFormatter,
                g = a.canvas, l = a.gridArr || (a.gridArr = []), l = g.canvasLeft || e.canvasLeft, n = g.canvasTop || e.canvasTop, u = g.canvasHeight || e.canvasHeight, p = g.canvasWidth || e.canvasWidth, e = a.lastTranslate || (a.lastTranslate = {
                    x: 0,
                    y: 0
                ...
                if (a.hasCategory) {
                    ...
                    for (r in m)
                        if (m.hasOwnProperty(r) && "_attrib" !== r)
                            for (k in n = m[r].category, u = void 0, l = a.gridArr = [], n)
                                p = f.getDateValue(n[k].start).ms, t = f.getDateValue(n[k].end).ms, !n.hasOwnProperty(k) || "_attrib" === k || isNaN(p) || isNaN(t) || (p = {
                                    elem: n[k],
                                    elemIndex: g,
                                    pos: g,
                                    dimension: {
            ...
            placeAxis: function(a) {
                var b = this.config, c = this.chart, d = c.config, f = c.get("components").numberFormatter, e = c.linkedItems.smartLabel, h = b.labels.style, m = 0, g = {
                    top: 0,
                    bottom: 0
                },
                l = 0, n, u, p, t, r, x, k, C = b.trend.trendStyle, F = b.vTrendLines, H = b.useEllipsesWhenOverflow, y = 0, z = 0;
                ...
                if (b.hasCategory)
                    for (p in n = b.categories.category, n)
                        if (n.hasOwnProperty(p) && "_attrib" !== p) {
                            ...
                            u = n[p].category;
                            for (r in u)
                                u.hasOwnProperty(r) && "_attrib" !== r && (t = u[r], t.drawLabel = Y(t.label || t.name), x = t._attrib, x = {
                ...
                if (b.drawTrendLines && b.drawTrendLabels && F && b.isActive)
                    ...
                    b.trendBottomPadding =- 1, r = 0, h = F.length; r < h; r += 1)
                        for (p = 0, m = F[r].line.length; p < m; p += 1)
                            n = F[r].line[p], t = n.origText || n.displayvalue || n.endvalue || n.startvalue || "", t = Y(t), n.startvalue = n.start && f.getDateValue(n.start).ms, n.endvalue = n.end && f.getDateValue(n.end).ms, n.origText = t, t = e.getSmartText(t, c.canvasWidth, C.lineHeight, H), k = t.height + 2, 0 > u - k ? n.displayvalue = "" : (n.displayvalue = t.text, y = y < t.height ? t.height : y), t.tooltext ? n.valueToolText = t.tooltext : delete n.valueToolText;
                b.totalHeight = l;
        ...
        Q.get("component", ["axis", "process", {
            ...
            setProcess: function(a) {
                ...
                if (a) {
                    ...
                    for (c = 0; c < a; c += 1)
                        h = e.process[c], h.id && (m[h.id.toLowerCase()] = {
                            catObj: h,
                            index: c
                        });
                    b = a - 1 + b;
            ...
            setProcessHeight: function() {
                var a = this.config, b = this.chart.config.canvasHeight, c = a.processes.process.process, d = a.processes.processHeightMap, f = a.processMaxHeight, e = 0, h = a.forceRowHeight, m = a.rowHeight;
                if (f * c.length < b || 0 === a.useVerticalScrolling)
                    f = b / c.length;
                0 === h ? m && m > f && (f = m) : f = m || f;
                h = 0;
                for (b = c.length; h < b; h++)
                    a = r(c[h].height, f), d[h] = {
                        top: e,
                        bottom: e + a,
                        height: a
                    }, e += a;
            ...
            _drawProcessAndDataTable: function() {
                var a = this.config, b = this.chart, c = (a.axisDimention || {}).x, d = a.totalWidth || 0, f = a.gridArr ||
                (a.gridArr = []), e = a.canvas, h = b.config, f = b.components.paper, m = e.canvasTop || h.canvasTop, g = e.canvasLeft || h.canvasLeft, l = e.canvasHeight || h.canvasHeight, n = e.canvasWidth || h.canvasWidth, u = b.graphics, p = u.axisBottomGroup, e = a.totalVisiblelWidth, t, q = 0, r, k, C, F;
                ...
                if (a.hasProcess)
                    ...
                    0, l = process.length; t < l; t++)
                        g = this.getProcessPositionByIndex(t), g = {
                            elem: process[t],
                            elemIndex: q,
                            pos: t,
                            dimension: {
                    ...
                    for (t in f)
                        if (f.hasOwnProperty(t) && "_attrib" !== t)
                            for (r in g = {
                                ...
                                type: "header"
                            }, this._drawProcessAndDataTableElement(g), q += 1, l = f[t].text, l)
                                l[r]._attrib && process[r] && process[r]._attrib && (l[r]._attrib.hoverbandcolor = process[r]._attrib.hoverbandcolor, l[r]._attrib.hoverbandalpha = process[r]._attrib.hoverbandalpha, l[r]._attrib.showhoverband = process[r]._attrib.showhoverband), l.hasOwnProperty(r) && "_attrib" !== r && (g = this.getProcessPositionByIndex(r), g = {
                                    elem: l[r],
                                    elemIndex: q,
                                    pos: r,
                                    dimension: {
            ...
            _drawVerticalLineAndTracker: function() {
                var a = this, b = a.config, c = a.chart, d = c.config, f = (b.axisDimention || {}).x, e = b.totalWidth || 0, h = b.canvas.canvasTop || d.canvasTop, m = c.components.paper, g = a.components.processVline ||
                (a.components.processVline = []), l = b.processVlineArr, n = b.hotContainer, u = 0, p, t, q, r, k, C, F, H = function() {
                    ...
                    var b = this.data("drag-options"), c = b.vHoverLine, d = b.vLineSetting, e = d.xPos + a, f = d.leftLimit, g = d.rightLimit;
                    e < f && (a = f - d.xPos);
                    e > g && (a = g - d.xPos);
                    d = {
                ...
                for (p = l.length; d < p; d += 1)
                    t = "process" === l[d].type ? b.processes.process.process : b.dataTables.dataTable.datacolumn[l[d].ind], t = f - e + t._attrib.rightPos, t = ["M", t, r, "L", t, h + b.processTotalHeight], g[u] ? (F = g[u].graphics.vHoverLine, F.attr({
                        path: t
                ...
                d = u;
                for (p = g.length; d < p; d += 1)
                    g[d].graphics.vHoverLine.attr({
                        path: ["M", 0, 0]
            ...
            placeAxis: function(a) {
                var b = this.config, c = this.chart, d = c.linkedItems.smartLabel, f = b.labels.style, e = 0, h = 0, m = {
                    left: 0,
                    right: 0
                }, g = 0, l=!1, n = 0, u = 0, p,
                t, r, x, k, C = 0;
                ...
                if (b.hasProcess) {
                    ...
                    p = 0;
                    for (t = process.length; p < t; p++)
                        r = process[p], c = r._attrib, r.drawLabel = Y(r.label || r.name), c = {
                ...
                if (b.hasDataTables)
                    for (p in e = b.dataTables.dataTable.datacolumn, e)
                        if (e.hasOwnProperty(p) && "_attrib" !== p) {
                            ...
                            u = u.text;
                            for (x in u)
                                u.hasOwnProperty(x) && "_attrib" !== x && (c = u[x], c.drawLabel = Y(c.label || c.name), t = c._attrib, t = {
            ...
            adjustWidth: function() {
                ...
                if (a.hasDataTables)
                    for (n in g = a.dataTables.dataTable.datacolumn, g)
                        if (g.hasOwnProperty(n) && "_attrib" !== n) {
                            ...
                            h.rightPos = d;
                            if (l = e[e.length - 1])
                                l.right = h, l.rightLimit = h.rightPos - 20;
                                e.push({
                                    type: "dataTable",
                                    ind: n,
                                    xPos: h.rightPos,
                ...
                if (a.hasProcess)
                    if (f) {
                        if (h =
                        process._attrib, h.rightPos = d + (h.rightPos - h.leftPos), h.leftPos = d, d += h.rightPos - h.leftPos, l = e[e.length - 1])
                            l.right = h, l.rightLimit = h.rightPos - 20
                    } else 
                        e.pop();
                a.totalWidth = d
