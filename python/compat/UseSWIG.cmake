...
macro(SWIG_ADD_SOURCE_TO_MODULE name outfiles infile)
  ...
  if (include_directories)
    # include_directories *sometimes* gets spaces instead of semicolons
    # separating stuff. Brilliant! Force them to use semicolons with list
    # append first.
    set(include_directories_2 "")
    list(APPEND include_directories_2 ${include_directories})
    # They can't stay semicolons though, nooOOOoo, that would break the outer
    # list. No, we have to escape the semicolons first!
    string(REPLACE ";" "\\;" include_directories_2 "${include_directories_2}")
    # And then there's this fucking abomination.
    list(APPEND swig_source_file_flags "$<$<BOOL:${include_directories_2}>:--FIX$<COMMA>$<JOIN:${include_directories_2},$<COMMA>SEP$<COMMA>>>")
    # Why is this so difficult, kitware? What the actual fuck? Why can't I get
    # a list of transitive include directories without the code generator being
    # involved in the first place? WHY
  endif()
  # ^^^ ADDED ^^^
  ...
  add_custom_command(
    ...
    ARGS "${CMAKE_CURRENT_SOURCE_DIR}/compat/fix-swig-cmdline.py"
    "${SWIG_EXECUTABLE}"
