...
class TestAlapRcSchedule(unittest.TestCase):
    _scheduler = 'ALAP'
    config_fn = 'cc_light'
    ...
    def test_qwg(self):
        ...
        starmon = ql.Platform("starmon", self.config_fn)
        ...
        gold_fn = os.path.join(qasm_golden_dir, prog.name + '_last.qasm')
    ...
    def test_issue_179(self):
        ...
        # the y q3 must be in another cycle than the x's because x conflicts with y in qwg1
