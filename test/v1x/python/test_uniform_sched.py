...
class TestUniformScheduler(unittest.TestCase):
    @classmethod
    def setUp(cls):
        ql.initialize()
    ...
    def test_uniform_scheduler_0(self):
        ...
        config_fn = os.path.join(json_dir, 'test_cfg_none_s7.json')
        ...
        # a simple first test
        # the x gates serve to separate the cnot gates wrt dependencies
