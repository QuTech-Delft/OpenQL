...
class TestBasic(unittest.TestCase):
    ...
    def test_smis(self):
        ...
        gold_fn = os.path.join(qasm_golden_dir, p.name + '_last.qasm')
    ...
    def test_smis_all_bundled(self):
        ...
        qasm_fn = os.path.join(output_dir, p.name + '_last.qasm')
        gold_fn = os.path.join(qasm_golden_dir, 'test_smis_all_bundled_last.qasm')
...
class TestAdvance(unittest.TestCase):
    ...
    def test_ccl_buffers(self):
        ...
        for testNo, testKernel in tests:
            ...
            config_fn = os.path.join(json_dir, 'test_cfg_cc_light_buffers_latencies.json')
