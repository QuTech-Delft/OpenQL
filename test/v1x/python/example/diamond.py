...
# from config import cq_example_dir
...
# platform.get_compiler().prefix_pass(
#     'io.cqasm.Read', '',
#     {'cqasm_file': os.path.join(cq_example_dir, 'diamond.cq'), 'measure_all_target': 'measure_z'})

num_qubits = 3
p = ql.Program("testProgram", platform, num_qubits)
k = ql.Kernel("testKernel", platform, num_qubits)
