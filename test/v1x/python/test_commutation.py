...
from config import qasm_golden_dir, output_dir
...
class TestCommutation(unittest.TestCase):
    ...
    def test_cnot_z_nn_commute(self):
        ...
        p = ql.Program("test_cnot_z_NN_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_z_2n_commute(self):
        ...
        p = ql.Program("test_cnot_z_2N_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_z_2r_commute(self):
        ...
        p = ql.Program("test_cnot_z_2R_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_x_nn_commute(self):
        ...
        p = ql.Program("test_cnot_x_NN_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_x_2n_commute(self):
        ...
        p = ql.Program("test_cnot_x_2N_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_x_2r_commute(self):
        ...
        p = ql.Program("test_cnot_x_2R_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_nn_non_commute_rad(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_NN_non_commute_RAD", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_2r_non_commute_rad(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_2R_non_commute_RAD", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_nn_non_commute_dar(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_NN_non_commute_DAR", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_2r_non_commute_dar(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_2R_non_commute_DAR", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_nn_control_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_NN_control_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_2n_control_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_2N_control_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_2r_control_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_2R_control_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_nn_target_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_NN_target_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_2n_target_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_2N_target_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_2r_target_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cnot_2R_target_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cz_nn_any_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cz_NN_any_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cz_2n_any_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cz_2N_any_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cz_2r_any_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        p = ql.Program("test_cz_2R_any_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
    ...
    def test_cnot_mixed_commute(self):
        platform = ql.Platform("starmon", config_fn)
        ...
        # the only dependencies are those reflecting that
        ...
        p = ql.Program("test_cnot_mixed_commute", platform, num_qubits)
        p.add_kernel(k)
        p.compile()
...
#
#
#        p = ql.Program("test_cnot_variations", platform, num_qubits)
#        p.add_kernel(k)
#        p.compile()
#
#        gold_fn = os.path.join(qasm_golden_dir, p.name + '_scheduled.qasm')
