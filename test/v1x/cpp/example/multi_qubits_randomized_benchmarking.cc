...
namespace example_multi_qubits_randomized_benchmarking {
...
TEST(v1x_example, multi_qubits_randomized_benchmarking) {
    using namespace example_multi_qubits_randomized_benchmarking;
